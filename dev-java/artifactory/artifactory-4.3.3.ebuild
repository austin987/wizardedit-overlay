...
SRC_URI="https://bintray.com/artifact/download/jfrog/artifactory/jfrog-artifactory-oss-${PV}.zip -> ${P}.zip"
...
src_prepare() {
	...
	sed -i -e "s%/etc/opt/jfrog/artifactory/default%/etc/conf.d/${PN}%g;" misc/service/setenv.sh || die
}
